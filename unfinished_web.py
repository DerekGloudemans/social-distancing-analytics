...
@app.route('/')
def index():
    # location = ['Red', 'Blue', 'Black', 'Orange']
    return render_template('fancy_index.html', async_mode=socketio.async_mode) #, colours=colours)

@app.route('/', methods=['GET'])
def dropdown():
    colours = ['Red', 'Blue', 'Black', 'Orange']
    return render_template('.html', colours=colours)
